...
//    , glasses_a        (Category.eye,       "glasses-a",       "Glasses")
    , glasses_b        (Category.eye,       "glasses-b",       "Glasses")
    , glasses_big        (Category.eye,       "glasses-big-a",       "Haute Couture")
...
//    , tongue           (Category.mouth,     "tongue",          "Tongue")
    ...
    , clean_shaven     (Category.hair_face, "feature-blank",   "No facial hair")
